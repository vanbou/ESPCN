...
parser.add_argument('--input', type=str, required=False, default='dataset/BSDS300/images/3.png', help='input image to use')
parser.add_argument('--model', type=str, default='1.pth', help='model file to use')
